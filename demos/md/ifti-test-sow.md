# Scope of Work: Money Management Software Development
...
- [User Stories](#user-stories)
  - [US-001: User Registration](#us-001-user-registration)
    - [Feature US-001: User Registration](#feature-us-001-user-registration)
...
- I want create an account on the application
...
Feature: User Registration
  Scenario: User can enter username and password
    ...
    When they need create an account on the application
    Then they can manage my finances effectively
```
...
| --- | --- | --- | --- | --- | --- |
| US-001 | User Registration | User Registration | 2 | 16 | High |
...
| Estimated Hours | 160 (assuming 8 hours per story point) |
| Hourly Rate | $25.00 |
| Base Cost | $4,000.00 |
| Overhead (25.0%) | $1,000.00 |
| Profit Margin (20.0%) | $1,000.00 |
